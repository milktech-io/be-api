...
{
    protected function createPermissions($tableNames)
    {
    ...
    protected function createRoles($tableNames, $teams, $columnNames)
    {
    ...
    public function up()
    {
        ...
        if (empty($tableNames)) {
            error_log('Error: config/permission.php not loaded. Run [php artisan config:clear] and try again.');
            exit();
        }
        ...
        $this->createPermissions($tableNames);
        $this->createRoles($tableNames, $teams, $columnNames);
