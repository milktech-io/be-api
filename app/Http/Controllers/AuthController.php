...
use App\Http\Requests\AuthController\MigrationCheckRequest;
use App\Http\Requests\AuthController\MigrationRequest;
...
class AuthController extends Controller
{
    ...
    public function migration(MigrationRequest $request)
    {
        return $this->DisruptiveService->migration($request->validated());
    }

    public function migrationCheck(MigrationCheckRequest $request)
    {
        return $this->DisruptiveService->migrationCheck($request->validated());
    }
