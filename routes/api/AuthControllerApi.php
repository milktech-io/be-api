...
class AuthControllerApi
{
    public static function set()
    {
        Route::prefix('auth')->group(function () {
            ...
            Route::post('/ethereum/signature', [AuthController::class, 'signature'])->name('signature');
            Route::post('/ethereum/authenticate', [AuthController::class, 'authenticate'])->name('authenticate');
        });
    }
